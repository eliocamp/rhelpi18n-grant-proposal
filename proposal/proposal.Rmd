...
The idea is to extend the R help system to allow for multiple help pages for the same function in different languages by installing translation modules.
